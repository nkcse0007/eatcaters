...
var JwtInterceptor = /** @class */ (function () {
    function JwtInterceptor(router, spinner) {
        this.router = router;
...
var WebsiteserviceService = /** @class */ (function () {
    function WebsiteserviceService(http) {
        this.http = http;
        this.baseUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].BASE_URL;
    }
    WebsiteserviceService.prototype.getTermCondition = function () {
        return this.http.get(this.baseUrl + 'customerlist.json?key=7194e520');
    };
    WebsiteserviceService.ctorParameters = function () { return [
...
var routes = [
    {
        path: '',
        loadChildren: function () { return Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./modules/website/website.module */ "./src/app/modules/website/website.module.ts")).then(function (module) { return module.WebsiteModule; }); }
    },
    { path: 'admin',
        loadChildren: function () { return Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./modules/admin-panel/auth/auth.module */ "./src/app/modules/admin-panel/auth/auth.module.ts")).then(function (module) { return module.AuthModule; }); }
    },
    { path: 'admin/pages', loadChildren: function () { return Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./modules/admin-panel/common-pages/common-pages.module */ "./src/app/modules/admin-panel/common-pages/common-pages.module.ts")).then(function (module) { return module.CommonPagesModule; }); } }
];
...
var CommonPagesRoutingModule = /** @class */ (function () {
    function CommonPagesRoutingModule() {
    }
    ...
    return CommonPagesRoutingModule;
}());
...
var CommonPagesComponent = /** @class */ (function () {
    function CommonPagesComponent() {
    }
    CommonPagesComponent.prototype.ngOnInit = function () {
    };
...
var AdminAboutUsComponent = /** @class */ (function () {
    ...
    AdminAboutUsComponent.prototype.ngOnInit = function () {
    };
...
var AdminCareersComponent = /** @class */ (function () {
    function AdminCareersComponent() {
    }
...
var AdminDammamComponent = /** @class */ (function () {
    function AdminDammamComponent() {
    }
    AdminDammamComponent.prototype.ngOnInit = function () {
    };
...
var AdminJeddahComponent = /** @class */ (function () {
    function AdminJeddahComponent() {
    }
    AdminJeddahComponent.prototype.ngOnInit = function () {
    };
...
var AdminPrivacyPolicyComponent = /** @class */ (function () {
    function AdminPrivacyPolicyComponent() {
        this.editorConfig = {
            editable: true,
            spellcheck: false,
            height: '17rem',
    ...
    AdminPrivacyPolicyComponent.prototype.ngOnInit = function () {
    };
    ...
    return AdminPrivacyPolicyComponent;
}());
...
var AdminRiyadhComponent = /** @class */ (function () {
    function AdminRiyadhComponent() {
    }
    AdminRiyadhComponent.prototype.ngOnInit = function () {
    };
...
var TermsAndUseComponent = /** @class */ (function () {
    function TermsAndUseComponent() {
        this.editorConfig = {
            editable: true,
            spellcheck: false,
            height: '17rem',
    ...
    TermsAndUseComponent.prototype.ngOnInit = function () {
    };
...
/* harmony import */ var ngx_wow__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ngx-wow */ "./node_modules/ngx-wow/esm5/ngx-wow.es5.js");
...
/* harmony import */ var ngx_editor__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ngx-editor */ "./node_modules/ngx-editor/fesm5/ngx-editor.js");
...
var DammamComponent = /** @class */ (function () {
    function DammamComponent() {
    }
    DammamComponent.prototype.ngOnInit = function () {
    };
...
var TermsOfUseComponent = /** @class */ (function () {
    function TermsOfUseComponent(webservices) {
        this.webservices = webservices;
    }
    TermsOfUseComponent.prototype.ngOnInit = function () {
        this.getTermUseContent();
    };
    TermsOfUseComponent.prototype.getTermUseContent = function () {
        var _this = this;
        this.webservices.getTermCondition().subscribe(function (data) {
            _this.termsContent = data;
            console.log('terms data', _this.termsContent);
        });
    };
    TermsOfUseComponent.ctorParameters = function () { return [
