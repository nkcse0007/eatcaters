...
@NgModule({
  declarations: [TermsAndUseComponent, AdminPrivacyPolicyComponent, CommonPagesComponent, AdminCareersComponent, AdminFaqComponent, AdminDammamComponent, AdminJeddahComponent, AdminRiyadhComponent, DashboardComponent, UsersComponent, CategoryComponent, ItemsComponent, ExtraComponent, DriversComponent, BranchstatusComponent, RegionsComponent, CarrersComponent, BannertitleComponent, SupportComponent, WhychooseComponent, AppimageComponent, SettingComponent, AllUsersComponent, SaucesComponent, Side1Component, Side2Component, AdditionalComponent, AboutusComponent],
  imports: [
    CommonModule,
