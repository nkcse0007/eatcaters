...
export class Side1Component implements OnInit {
    ...
    deleteCategory(id) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: 'You will not be able to recover this side1 !',
            icon: 'warning',
