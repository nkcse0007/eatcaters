...
export class Side2Component implements OnInit {
    ...
    deleteCategory(id) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: 'You will not be able to recover this Side2 !',
            icon: 'warning',
