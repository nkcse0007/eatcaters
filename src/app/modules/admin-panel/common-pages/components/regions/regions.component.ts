...
export class RegionsComponent implements OnInit {
  ...
  imagePath: any;
  uploadedImage: any = '';
  displayedColumns: string[] = ['select', 'name', 'nameArabic', 'action'];
  ...
  onSubmit() {
    ...
    if (this.categoryId) {
      ...
      if (this.categoryForm.valid) {
        this.loader = true;
        this.contentService.addRegion(formData).subscribe(res => {
  ...
  getCategories() {
    this.loader = true;
    this.contentService.getregion().subscribe(res => {
  ...
  deleteCategory(id) {
    ...
    Swal.fire({
      title: 'Are you sure?',
      text: 'You will not be able to recover this region !',
      icon: 'warning',
      ...
      if (result.value) {
        this.contentService.deleteRegion(formData).subscribe(res => {
          Swal.fire(
            'Deleted!',
